...
class Constants:
    ...
    CHROME_PROFILE_DZ = (
        '/Users/luisdavid/Documents/automation/keyword/chrome_profile'
    )
    ...
    DESKTOP_PLATFORMS = ['WIN10', 'WIN1064']
    FF_WINDOWS_WIDTH = {
        'mobile': '--width=360',
        'tablet': '--width=768,',
        'desktop': '--width=1366',
    ...
    PLATFORM_MAC = 'MAC'
    PLATFORM_WIN = 'WIN'
    PLATFORMS_WITH_UA = ['WIN10', 'WIN1064', 'ANDROID', 'IOS']
    SAFARI_WINDOWS_WIDTH = {'mobile': '360', 'tablet': '768', 'desktop': '1366'}
    ...
    SCROLL_TO_CATEGORY_HORIZONTAL_FEED = (
