LATEST_FEED = {
    ...
    '/intl/es-419/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=&paginate=7&show_hero=False&site_id=13&tags=&template=latestArticleItem',
    '/intl/it-it/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=&paginate=7&show_hero=True&site_id=15&tags=&template=latestArticleItem',
    ...
    '/intl/en-ca/products/explore-get-answers/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=True&paginate=7&site_id=11&tags=doodles,google-assistant,google-earth,maps,news,search&template=latestArticleItem',
    '/intl/fr-ca/produits/explorez-obtenez-des-reponses/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=True&paginate=7&site_id=12&tags=google-assistant,google-earth,maps,news,search&template=latestArticleItem',
    '/intl/pt-br/produtos/android-chrome-play/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=True&paginate=7&site_id=14&tags=android,chrome,classroom,google-play,wear-os-by-google&template=latestArticleItem',
    '/intl/es-419/actualizaciones-de-producto/android-chrome-play/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=True&paginate=7&show_hero=&site_id=13&tags=android,chrome,google-play,wear-os-by-google&template=latestArticleItem',
    '/intl/it-it/prodotti/android-chrome-play/': '/api/v2/latest?author_ids=&category=&date_start=&date_stop=&hero_template=heroArticleItem&is_main_hero=True&paginate=7&show_hero=&site_id=15&tags=android,chrome,chromebooks,google-play,google-tv&template=latestArticleItem',
