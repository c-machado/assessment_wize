...
def pytest_bdd_step_error(request, feature, scenario, step, step_func, step_func_args, exception):
    print(f'Step failed: {step}', f'Scenario: {scenario}', f'Feature: {feature}', f'Exception: {exception}')
...
@pytest.fixture(autouse=True)
def set_web_browser(get_web_browser):
    print('set web browser', get_web_browser)
...
@pytest.fixture(autouse=True)
def set_viewport(get_viewport):
    print('set viewport', get_viewport)


# @pytest.fixture(params=["mobile", "desktop", "tablet"], scope="module")
@pytest.fixture(params=["desktop"], scope="module")
