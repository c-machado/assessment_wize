...
class PageLocators(object):
    ...
    article_read_more_mobile_no_additional = (By.CSS_SELECTOR, "section[data-component='uni-featured-article']")
    ...
    article_related_stories_published_at = (By.CSS_SELECTOR, ".uni-related-articles-cards__date")
    ...
    menu_subscribe_mobile_cta_sticky = (By.CSS_SELECTOR, ".sticky-form__mobile-cta >button")
    menu_subscribe_mobile_hamburger_cta = (By.CSS_SELECTOR, ".uni-navigation--mobile .uni-header__newsletter--cta--mobile")
    newsletter_close_icon = (By.CSS_SELECTOR, ".uni-subscribe-modal__icon-close-container")
    newsletter_email_field = (By.CSS_SELECTOR, ".newsletter-form:not(.sticky) .uni_subscribe_email")
    newsletter_sticky_email_field = (By.CSS_SELECTOR, ".newsletter-form.sticky .uni_subscribe_email")
    newsletter_error_email = (By.CSS_SELECTOR, ".newsletter-form:not(.sticky) .uni_subscribe_email--error")
    newsletter_sticky_error_email = (By.CSS_SELECTOR, ".newsletter-form.sticky .uni_subscribe_email--error")
    newsletter_modal = (By.CSS_SELECTOR, ".uni-subscribe-modal__body")
    newsletter_success_modal = (By.ID, "newsletter-form--success")
    newsletter_subscribe_cta = (By.CSS_SELECTOR, ".newsletter-form:not(.sticky) .newsletter-form__submit")
    newsletter_sticky_subscribe_cta = (By.CSS_SELECTOR, ".newsletter-form.sticky .newsletter-form__submit")
    # newsletter_subscribed_msg = (By.CSS_SELECTOR, ".newsletter-form__success-text p#subscribe_box_success_label")
    newsletter_subscribed_msg = (By.CSS_SELECTOR, ".newsletter-form:not(.sticky) #subscribe_box_success_label")
    newsletter_sticky_subscribed_msg = (By.CSS_SELECTOR, ".newsletter-form.sticky #subscribe_box_success_label")
    newsletter_homepage_subscribed_msg = (By.CSS_SELECTOR, ".newsletter-form:not(.sticky) #subscribe_success_label")
    press_titles_in_page = (By.CSS_SELECTOR, ".press-item__title")
    press_filter_by_type = (By.CSS_SELECTOR, ".uni-search-results-filters>div:nth-child(2)>div>select")
    press_filter_by_topic = (By.CSS_SELECTOR, ".uni-search-results-filters>div:nth-child(4)>div>select")
    press_filter_by_product = (By.CSS_SELECTOR, ".uni-search-results-filters>div:nth-child(3)>div>select")
    ...
    search_icon_nav_expanded = (By.CSS_SELECTOR, '.uni-search__button.uni-search__button-search')
