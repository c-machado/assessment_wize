...
Feature: As a user I would like to search content within the blog using the progress bar in an article page

    @search-article
    Scenario Outline: Test search suggestions in the progress bar are being showed according to the locale's content
    ...
    @search-article
    Scenario Outline: Test the search suggestions in the progress bar when there are special characters in the text to search
        Given a user is at the <keyword> site
        And the progress bar is visible
        When the user clicks the search icon
        And the user types the <text_to_search>
    ...
    @search-article
    Scenario Outline: Test search results in the progress bar are being showed according to the locale's content
        Given a user is at the <keyword> site
        And the progress bar is visible
        When the user clicks the search icon
        And the user types the <text_to_search>
    ...
    @search-article
    Scenario Outline: Test search results in the progress bar when there are special characters are being showed according to the locale's content
        Given a user is at the <keyword> site
        And the progress bar is visible
        When the user clicks the search icon
        And the user types the <text_to_search>
