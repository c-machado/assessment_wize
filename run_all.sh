...
#////pytest tests/ -m "header_business_critical" --html=reports/blog/business_critical_header-lf.html # BEI
#////pytest tests/ -m "search_nav_business_critical" --html=reports/blog/business_critical_search_nav-lf.html # GABO
...
pytest tests/ -m "article-related" --html=reports/blog/business_critical_article-related.html # BEI

#////pytest tests/ -m "standalone_newsletter" --html=reports/blog/business_critical_standalone_newsletter.html # BEI
pytest tests/ -m "toast_standalone_newsletter" --html=reports/blog/business_critical_toast_standalone_newsletter-lf.html # BEI
...
#
pytest tests/ -m "header_regression" --html=reports/blog/regression_header.html # BEI
##/ok-(doesn't exist)-pytest tests/ -m "search_regression" --html=reports/blog/regression_search.html # GABO
pytest tests/ -m "footer_regression" --html=reports/blog/regression_footer.html # BEI
#
