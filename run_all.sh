...
#
#pytest tests/ -m "feed-article-load-more" --html=reports/blog/feed-load-more-lf.html
#pytest tests/ -m "feed-article-tagging" --html=reports/blog/feed-tagging-lf.html
#pytest tests/ -m "feed-article-date-format" --html=reports/blog/feed-date-format-lf.html
###
...
#
#pytest tests/ -m "press1" --html=reports/blog/press1.html
