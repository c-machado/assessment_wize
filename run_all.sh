...
#pytest tests/ -m "videos" --html=reports/blog/business_critical_article-videos.html # BEI
...
#pytest tests/ -m "search_regression" --html=reports/blog/regression_search.html # GABO
...
#pytest tests/ -m "feed-article-load-more" --html=reports/blog/feed-load-more-lf.html # GABO
